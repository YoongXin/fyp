...
fof(performance, axiom, ((! [X,Y,O,D] : (((((name(X,Alice)) & (name(Y,Bob))) & (date(D,59305))) & (objectPound(O,100))) & (paid(X,Y,O,D)))) & (~ (! [X,Y,O,D] : (((((name(X,Bob)) & (name(Y,Alice))) & (date(D,59309))) & (objectOtherObject(O,bicycle))) & (delivered(X,Y,O,D))))))).
