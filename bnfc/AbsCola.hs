...
data ConditionalDefinition
    = ConDefIf Definition Condition | ConDefIfThen Condition Definition
  deriving (C.Eq, C.Ord, C.Show, C.Read)
...
data Date
    ...
    | DateA
    | DateThe
    | DateMonRange TemporalQuantifier Month
    | DateYearRange TemporalQuantifier Num
    | DateRange TemporalRange
  deriving (C.Eq, C.Ord, C.Show, C.Read)

data TemporalQuantifier
    = TempWithin | TempAfter | TempBefore | TempIn
  deriving (C.Eq, C.Ord, C.Show, C.Read)

data TemporalRange = BtwMonth Month Month | BtwYear Num Num
  deriving (C.Eq, C.Ord, C.Show, C.Read)
...
data Object
    = ObjNu NumericalObject
    | ObjNonNu NonNumericalObject
    | ObjAdjNonNu Adjective NonNumericalObject
    | ObjRange NumericalObject NumericalObject
  deriving (C.Eq, C.Ord, C.Show, C.Read)
