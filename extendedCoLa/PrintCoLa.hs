...
instance Print AbsCoLa.ConditionalDefinition where
  prt i = \case
    ...
    AbsCoLa.ConDefIfElse definition1 condition definition2 -> prPrec i 0 (concatD [prt 0 definition1, doc (showString "IF"), prt 0 condition, doc (showString "ELSE"), prt 0 definition2])
    AbsCoLa.ConDefIfThenElse condition definition1 definition2 -> prPrec i 0 (concatD [doc (showString "IF"), prt 0 condition, doc (showString "THEN"), prt 0 definition1, doc (showString "ELSE"), prt 0 definition2])
...
instance Print AbsCoLa.ConditionalStatement where
  prt i = \case
    ...
    AbsCoLa.ConStateIfElse statement1 condition statement2 -> prPrec i 0 (concatD [prt 0 statement1, doc (showString "IF"), prt 0 condition, doc (showString "ELSE"), prt 0 statement2])
    AbsCoLa.ConStateIfThenElse condition statement1 statement2 -> prPrec i 0 (concatD [doc (showString "IF"), prt 0 condition, doc (showString "THEN"), prt 0 statement1, doc (showString "ELSE"), prt 0 statement2])
...
instance Print AbsCoLa.Date where
  prt i = \case
    ...
    AbsCoLa.DateQuanSomeWO temporaloffset temporalquantifier subject -> prPrec i 0 (concatD [prt 0 temporaloffset, prt 0 temporalquantifier, doc (showString "SOMEDATE"), prt 0 subject])
