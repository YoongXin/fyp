...
con.statement(TemporalStatement('"Bob"', 'MAY', 'Deliver', 'OtherObject "receipt"', 'to "Alice"', TemporalExpression('ON','(5,4,2021)'), valid=True))

con.statement(TemporalStatement('"Bob"', 'SHANT', 'Charge', 'OtherObject "delivery_fee"', 'to "Alice"', TemporalExpression('ON','(5,4,2021)'), valid=True))

con.statement(ConditionalStatement(condition=OrCondition(conditions=[TemporalActionCondition('"Alice"', 'Paid' , 'Pounds 100', 'to "Bob"', TemporalExpression('ON','(1,4,2021)'), test=True),
                TemporalActionCondition('"Alice"', 'Paid' , 'Pounds 120', 'to "Bob"', TemporalExpression('ON','(1,4,2021)'), test=True),
                ]), statement=TemporalStatement('"Bob"', 'SHALL', 'Deliver', 'OtherObject "bicycle"', 'to "Alice"', TemporalExpression('ON','(5,4,2021)'), valid=True)))
