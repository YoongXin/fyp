...
%token
  ...
  'EUR'          { PT _ (TS _ 14) }
  'EUROS'        { PT _ (TS _ 15) }
  'February'     { PT _ (TS _ 16) }
  'GBP'          { PT _ (TS _ 17) }
  'IF'           { PT _ (TS _ 18) }
  'IS'           { PT _ (TS _ 19) }
  'January'      { PT _ (TS _ 20) }
  'July'         { PT _ (TS _ 21) }
  'June'         { PT _ (TS _ 22) }
  'MINUS'        { PT _ (TS _ 23) }
  'March'        { PT _ (TS _ 24) }
  'May'          { PT _ (TS _ 25) }
  'NAMEDOBJECT'  { PT _ (TS _ 26) }
  'November'     { PT _ (TS _ 27) }
  'OR'           { PT _ (TS _ 28) }
  'OTHEROBJECT'  { PT _ (TS _ 29) }
  'October'      { PT _ (TS _ 30) }
  'PLUS'         { PT _ (TS _ 31) }
  'POUNDS'       { PT _ (TS _ 32) }
  'REPORT'       { PT _ (TS _ 33) }
  'SOMECURRENCY' { PT _ (TS _ 34) }
  'SOMEDATE'     { PT _ (TS _ 35) }
...
ConditionalDefinition
  ...
  | Definition 'IF' Condition 'ELSE' Definition { AbsCoLa.ConDefIfElse $1 $3 $5 }
  | 'IF' Condition 'THEN' Definition 'ELSE' Definition { AbsCoLa.ConDefIfThenElse $2 $4 $6 }
...
ConditionalStatement
  ...
  | Statement 'IF' Condition 'ELSE' Statement { AbsCoLa.ConStateIfElse $1 $3 $5 }
  | 'IF' Condition 'THEN' Statement 'ELSE' Statement { AbsCoLa.ConStateIfThenElse $2 $4 $6 }
