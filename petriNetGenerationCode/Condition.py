...
from General import VerbStatus, Evaluation, Receiver
...
class ActionCondition(Condition):
    def __init__(self, subject: str, verb_status: str, object: str, receiver: str, test=True):
        super().__init__(test)
    ...
    def label(self) -> str:
        return f"{self.subject().label()} {self.verb_status().value} {self.object().label()} {self.receiver().label()}"


class TemporalActionCondition(ActionCondition):
    def __init__(self, subject: str, verb_status: str, object: str, receiver:str, temporalExpression, test=True):
        super().__init__(subject, verb_status, object, receiver, test)
