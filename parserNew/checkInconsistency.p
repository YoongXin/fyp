...
fof(contract, axiom, (! [D1] : (((! [X,Y,O,D] : (((((name(X,Mandy)) & (name(Y,Nancy))) & (date(D,59311))) & (objectPound(O,17))) & (paid(X,Y,O,D)))) => (! [X,Y,O] : (((((name(X,Nancy)) & (name(Y,Mandy))) & (isDate(D1))) & (objectOtherObject(O,bag))) & (mustDeliver(X,Y,O,D1))))) & (unknownOne = 59313)))).

%TPTP representation for the performance:

fof(performance, axiom, (! [D1] : ((! [X,Y,O,D] : (((((name(X,Mandy)) & (name(Y,Nancy))) & (date(D,59311))) & (objectPound(O,17))) & (paid(X,Y,O,D)))) & (! [X,Y,O,D] : (((((name(X,Nancy)) & (name(Y,Mandy))) & (date(D,59313))) & (objectOtherObject(O,bag))) & (delivered(X,Y,O,D))))))).
