...
transConditionalDefinition x = case x of
  ...
  AbsCoLa.ConDefIfElse definition1 condition definition2 -> failure x
  AbsCoLa.ConDefIfThenElse condition definition1 definition2 -> failure x
...
transConditionalStatement x = case x of
  ...
  AbsCoLa.ConStateIfElse statement1 condition statement2 -> failure x
  AbsCoLa.ConStateIfThenElse condition statement1 statement2 -> failure x
